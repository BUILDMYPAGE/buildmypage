...
export const skills = [
  "Hand code Angular, TypeScript, JavaScript, React, HTML, HTML5, CSHTML, XHTML, CSS3, SASS, Ionic Cordova, XML, PHP, MySQL, jQuery, GitHub Copilot, and ASP.net",
  ...
  "Extensive knowledge in Angular 17 framework and TypeScript methods",
  "Familiar with React components, props, constants, lets, maps, hooks, and more",
  ...
  "Extensive knowledge in mobile frameworks such as jQuery UI and Bootstrap",
  ...
  "Extensive knowledge in CMS (Joomla, WordPress, Drupal, Freedom) and OpenCart and WooCommerce ecommerce websites",
  ...
  "Experienced in GitHub Copilot AI assisted coding for improved productivity",
  "Experienced with NPM (node package manager) and commonly used modules",
  "Familiar with running SAS stored procedures",
  "Strong knowledge in NodeJS applications",
  "Experienced with Angular material themes @mixin and core component development using custom directives",
];
